...
DRIVE WORK:
- qol/house-max-items-display (needs testing)
	- record this with first change for max items
- qol/enhanced-rotate (needs testing)
- qol/city-specs (needs tre work + testing)

### Global Bank
```bash
# https://github.com/swgsremu/sentinelsrepublic-server/commit/06a858173e75254dcb5698bf4fffb47db4411f1f
todo
```
- todo
...
❌ Untested
```bash
# first, try enabling it in this file: /Users/j/code/ppswg/MMOCoreORB/src/server/zone/objects/tangible/components/BankTerminalMenuComponent.h

# if that doesn't work, take a look at: https://github.com/swgsremu/sentinelsrepublic-server/commit/83dba604a80c8b7029b65b29208f220bf15e1537
todo
```
- todo
