...
<NoteJumpMenu client:load title="Jump to Profession" links={[
	{title: 'QOL Changes', path: '#implemented-qol-changes'},
	{title: 'TRE File Edits', path: '#tre-file-edits'},
	{title: 'Gameplay Updates', path: '#gameplay-updates'},
	{title: 'Backlog', path: '#backlog'},
	{title: 'Code References', path: '#code-references'},
...
## Credits
Thanks to SWGEmu's Core3 and all of the existing servers that share their code!
