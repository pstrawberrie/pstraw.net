...
<NoteJumpMenu client:load title="Jump to Profession" links={[
...
<NoteCallouts data={[
  {type: 'success', text: 'Visit the original guide on EQSanctum →', link: 'https://www.eqsanctum.com/topic/47-how-to-grind-everything/'},
  {type: 'info', text: 'Submit PR on github →', link: 'https://github.com/pstrawberrie/pstraw.net'},
]}/>
