...
After a month of work, the new version of pstraw.net is live and alive. Version 3 is the second major design update to hit the site following v2's experimental design overhaul. This update tightens everything up and introduces a more unified theme with modern spacing, consistent UI elements, consistent colors, and more complementary fonts. A working changelog for v3 is included below, as well as a quick write-up that looks back at pstraw.net's history, motivation, and future plans.
...
## The origin of pstraw.net

I decided to leave my agency job in 2023 to take a break from web development. The initial version of this codebase was released around December 2024 - about a year and a half from the time of my departure - with the purpose of being a simple, professional project to reference for job applications. I had never made a "professional" github account, so I was starting from zero and needed a solid project to show prospective employers I knew what I was doing. Along with the website, I also created a fake e-commerce site called [Cubes Direct](https://github.com/pstrawberrie/cubesdirect-vanilla) in tandem with the site's launch to .

After learning the basics of [Astro](https://astro.build/) and [Svelte](https://svelte.dev/), setting up the VPS, configuring the email service, adding a contact form, and releasing it, I launched the site.
