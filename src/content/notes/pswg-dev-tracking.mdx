...
<NoteCallouts
  data={[{ type: "error", text: "This project is no longer maintained" }]}
/>

## No Longer Maintained

As of late July 2025 I've decided to stop working on this project. It was fun to implement popular servers' code changes into the latest swgemu code with the help of AI. After a while, I just lost steam and wanted to move on to other projects.
...
- Added [infinity's socket chance calculation](https://github.com/swginfinity/public/blob/7a105dccac7a6783f263f63c01c8d24388c9ecc9/MMOCoreORB/src/server/zone/objects/tangible/wearables/WearableObjectImplementation.cpp#L72)
...
- Thanks to [this tarkin's revenge commit](https://bitbucket.org/tarkinsrevenge/tarkins-revenge/commits/01e8e9b4455ed8d8fb9f01f3c32c7dc9c6f48981)
...
- [QOL/Guild] Implement guild status command from [aftermath code](https://github.com/SWGAftermath/Aftermath/commit/e0f72f9f99113924ab8813baff6511fd011b7bf7?w=1)
